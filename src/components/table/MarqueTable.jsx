...
import MarqueForm from '../forms/marque/MarqueForm';

const MarqueTable = ({ data, onDelete }) => {
  ...
  const filteredData = data.filter((item) =>
    item.nommarque.toLowerCase().includes(filter.toLowerCase())
  );
    ...
    <div className="container mt-5">
      ...
      <div className="mb-3 mt-5">
        <input
          ...
          placeholder="Filtre par nom du marque"
          value={filter}
          ...
          {filteredData.map((item, index) => (
            <tr key={index}>
              ...
              <td>
                ...
                <button style={{ marginLeft: 15 }} className="btn btn-danger" onClick={() => handleDelete(item.idmarque)}>
                  Supprimer
                </button>
              </td>
            </tr>
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-body">
                <MarqueForm rowdata={selectedRowData} onModalClose={handleCloseModal} />
              </div>
            </div>
          </div>
        </div>
