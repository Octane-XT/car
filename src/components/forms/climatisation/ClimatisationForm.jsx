...
const ClimatisationForm = (props) => {
  ...
  const handleInputChange = (e) => {
    setNomclimatisation(e.target.value);
  };
  ...
  const handleSubmit = (e) => {
    ...
    if (props.rowdata && Object.keys(props.rowdata).length > 0) {
      ...
      const formData = {
        ...
        nomclimatisation: nomclimatisation,
        etat: 1
      };
  ...
  return (
    <div>
      <form className="forms-sample" onSubmit={handleSubmit}>
        <div className="mb-3">
          <label className="form-label">Nom climatisation</label>
          <input
            type="text"
            className="form-control"
            name="climatisationName"
            value={nomclimatisation}
...
export default ClimatisationForm;
